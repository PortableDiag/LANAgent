...
export class AIIntentDetector {
  ...
  defineBaseIntents() {
    return {
      ...
      64: {
        name: 'downloadVideo',
        description: 'Download video from URL — YouTube, TikTok, Rumble, BitChute, Streamable, Dailymotion, X/Twitter, Twitch, Bilibili, and ~1800 other sites supported by yt-dlp',
        plugin: 'ytdlp',
        action: 'download',
        examples: [
          ...
          'download this video',
          'save video from url',
          'get video from youtube.com',
          'download https://youtube.com',
          'download https://www.youtube.com/watch',
          'download as mp4',
          'youtube.com video',
          'get this youtube video',
          'download the video',
          'download this tiktok',
          'grab that tiktok video',
          'save this tiktok',
          'download https://tiktok.com',
          'download this rumble video',
          'grab the rumble clip',
          'save https://rumble.com',
          'download this bitchute video',
          'grab the bitchute clip',
          'save https://bitchute.com',
          'download this streamable',
          'save https://streamable.com',
          'download from dailymotion',
          'save this dailymotion video',
          'download this x.com video',
          'grab that twitter video',
          'save this tweet video',
          'download from x.com',
          'download this twitch clip',
          'save the twitch vod',
          'download this bilibili video',
          'grab that bilibili clip'
        ]
      },
      ...
      166: {
        ...
        examples: [
          ...
          'grab the audio from this tiktok',
          'pull the mp3 from this rumble video',
          'extract the audio from this bitchute clip',
          'get the audio from this x.com video',
          'mp3 from soundcloud',
          'download soundcloud as mp3',
          'audio from this streamable',
          'rip the audio from this dailymotion'
        ]
      },
